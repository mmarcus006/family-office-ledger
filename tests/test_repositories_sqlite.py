...
class TestSQLiteEntityRepository:
    def test_add_and_get_entity(self, entity_repo: SQLiteEntityRepository):
        entity = Entity(
    ...
    def test_get_nonexistent_entity_returns_none(
        self, entity_repo: SQLiteEntityRepository
    ):
        result = entity_repo.get(uuid4())
        assert result is None

    def test_get_by_name(self, entity_repo: SQLiteEntityRepository):
    ...
    def test_get_by_name_not_found(self, entity_repo: SQLiteEntityRepository):
        result = entity_repo.get_by_name("Nonexistent")
        assert result is None

    def test_list_all_entities(self, entity_repo: SQLiteEntityRepository):
    ...
    def test_list_active_entities(self, entity_repo: SQLiteEntityRepository):
    ...
    def test_update_entity(self, entity_repo: SQLiteEntityRepository):
        entity = Entity(name="Old Name", entity_type=EntityType.TRUST)
        entity_repo.add(entity)

        entity.name = "New Name"  # Note: This is just for our local object
        # Create a new entity with updated values for update
        updated = Entity(
            name="New Name",
    ...
    def test_delete_entity(self, entity_repo: SQLiteEntityRepository):
    ...
    def test_entity_preserves_timestamps(self, entity_repo: SQLiteEntityRepository):
...
class TestSQLiteAccountRepository:
    @pytest.fixture
    def persisted_entity(self, entity_repo: SQLiteEntityRepository) -> Entity:
        entity = Entity(name="Test Entity", entity_type=EntityType.TRUST)
        entity_repo.add(entity)
        return entity

    def test_add_and_get_account(
        self, account_repo: SQLiteAccountRepository, persisted_entity: Entity
    ):
        account = Account(
            name="Main Checking",
...
class TestSQLiteSecurityRepository:
    def test_add_and_get_security(self, security_repo: SQLiteSecurityRepository):
        security = Security(
            symbol="AAPL",
            name="Apple Inc.",
            cusip="037833100",
    ...
    def test_get_nonexistent_security_returns_none(
        self, security_repo: SQLiteSecurityRepository
    ):
        result = security_repo.get(uuid4())
        assert result is None

    def test_get_by_symbol(self, security_repo: SQLiteSecurityRepository):
    ...
    def test_get_by_symbol_not_found(self, security_repo: SQLiteSecurityRepository):
        result = security_repo.get_by_symbol("NONEXISTENT")
        assert result is None

    def test_get_by_cusip(self, security_repo: SQLiteSecurityRepository):
    ...
    def test_get_by_cusip_not_found(self, security_repo: SQLiteSecurityRepository):
        result = security_repo.get_by_cusip("000000000")
        assert result is None

    def test_list_all_securities(self, security_repo: SQLiteSecurityRepository):
    ...
    def test_list_qsbs_eligible(self, security_repo: SQLiteSecurityRepository):
    ...
    def test_update_security(self, security_repo: SQLiteSecurityRepository):
...
class TestSQLitePositionRepository:
    ...
    def test_add_and_get_position(
        self, position_repo: SQLitePositionRepository, test_data: dict
    ):
        position = Position(
    ...
    def test_get_nonexistent_position_returns_none(
        self, position_repo: SQLitePositionRepository
    ):
...
class TestSQLiteTransactionRepository:
    ...
    def test_add_and_get_transaction(
        self, transaction_repo: SQLiteTransactionRepository, test_accounts: dict
    ):
        txn = Transaction(
...
class TestSQLiteTaxLotRepository:
    @pytest.fixture
    def test_position(
        self,
        entity_repo: SQLiteEntityRepository,
    ...
    def test_add_and_get_tax_lot(
        self, tax_lot_repo: SQLiteTaxLotRepository, test_position: Position
    ):
        lot = TaxLot(
    ...
    def test_get_nonexistent_tax_lot_returns_none(
        self, tax_lot_repo: SQLiteTaxLotRepository
    ):
